...
const Acceuil = () => {
  ...
  return (
    <div className="flex-1 min-h-full bg-cover bg-[url('/acceuil.jpg')] flex flex-col items-center justify-start w-full">
      <h1 className="text-white text-4xl my-4">Mes favoris</h1>
      ...
      <div className="flex-1 flex w-full h-full">
        <div className="grid grid-cols-3 gap-4 w-full p-4 m-6 grid-rows-3">
          {currentItems.map((button, index) => (
            <div
              key={index}
              className="flex justify-center text-white text-xl items-center bg-white/5 hover:bg-white/10 hover:cursor-pointer p-4 rounded-lg transition-transform transform hover:scale-105"
              onClick={(event) => {
